	...
	public class BigInteger
	{
		...
		public BigInteger(byte[] bytes, int offset, int length)
		{
			...
			if ((sbyte)bytes[offset] < 0)
			{
				...
				array3[num4] = (byte)(array2[(long)intPtr] + 1);
		...
		public BigInteger(int bitLength, int certainty, Random random)
		{
			...
			while (true)
			{
				...
				array3[num2] = (byte)(array2[(long)intPtr] | 1u);
				magnitude = MakeMagnitude(array, 0, array.Length);
				nBits = -1;
				mQuote = 0;
		...
		private static int[] AddMagnitudes(int[] a, int[] b)
		{
			...
			if (num3 != 0)
			{
				while (num >= 0)
				{
					...
					int num4 = num--;
					IntPtr intPtr = (IntPtr)num4;
					if ((array2[num4] = array[(long)intPtr] + 1) != 0)
					{
						break;
					}
				}
			...
			else
			{
				...
				for (int num6 = num - 1; num6 >= 0; num6--)
				{
					...
					if (num5 >= 0)
					{
						...
						int num7 = num6;
						IntPtr intPtr = (IntPtr)num7;
						array3[num7] = array2[(long)intPtr] | (magnitude[num5] << num4);
					}
				}
			}
			return new BigInteger(sign, array, false);
