		...
		private long[][] GenerateWorkingKey(byte[] key)
		{
			...
			while (num6 < num3 && num5 < (ROUNDS + 1) * (BC / 8))
			{
				for (int k = 0; k < 4; k++)
				{
					...
					array4[num7] = array3[(long)intPtr] | ((long)(array[k, num6] & 0xFF) << num5 * 8 % BC);
				}
				num6++;
				num5++;
			}
			while (num5 < (ROUNDS + 1) * (BC / 8))
			{
				...
				for (int l = 0; l < 4; l++)
				{
					...
					array6[num8, 0] = (byte)(array5[(int)(long)intPtr, 0] ^ S[array[(l + 1) % 4, num3 - 1] & 0xFF]);
				}
				...
				if (num3 <= 6)
				{
					for (int m = 1; m < num3; m++)
					{
						for (int n = 0; n < 4; n++)
						{
							...
							int num10 = m;
							IntPtr intPtr2 = (IntPtr)num10;
							array7[num9, num10] = (byte)(array5[(int)(long)intPtr, (int)(long)intPtr2] ^ array[n, m - 1]);
						}
					}
				}
				else
				{
					for (int num11 = 1; num11 < 4; num11++)
					{
						for (int num12 = 0; num12 < 4; num12++)
						{
							...
							int num14 = num11;
							IntPtr intPtr2 = (IntPtr)num14;
							array8[num13, num14] = (byte)(array5[(int)(long)intPtr, (int)(long)intPtr2] ^ array[num12, num11 - 1]);
						}
					}
					for (int num15 = 0; num15 < 4; num15++)
					{
						...
						array9[num16, 4] = (byte)(array5[(int)(long)intPtr, 4] ^ S[array[num15, 3] & 0xFF]);
					}
					for (int num17 = 5; num17 < num3; num17++)
					{
						for (int num18 = 0; num18 < 4; num18++)
						{
							...
							int num20 = num17;
							IntPtr intPtr2 = (IntPtr)num20;
							array10[num19, num20] = (byte)(array5[(int)(long)intPtr, (int)(long)intPtr2] ^ array[num18, num17 - 1]);
						}
					}
				}
				int num21 = 0;
				while (num21 < num3 && num5 < (ROUNDS + 1) * (BC / 8))
				{
					for (int num22 = 0; num22 < 4; num22++)
					{
						...
						array11[num23] = array3[(long)intPtr] | ((long)(array[num22, num21] & 0xFF) << num5 * 8 % BC);
					}
					num21++;
					num5++;
				}
