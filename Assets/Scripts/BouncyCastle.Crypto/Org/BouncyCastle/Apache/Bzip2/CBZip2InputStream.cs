	...
	public class CBZip2InputStream : Stream
	{
		...
		private void GetAndMoveToFrontDecode()
		{
			...
			while (num10 != num2)
			{
				...
				if (num10 == 0 || num10 == 1)
				{
					...
					intPtr = (IntPtr)(int)c3;
					array3[(uint)c3] = array2[(long)intPtr] + num11;
					while (num11 > 0)
					{
						last++;
						ll8[last] = c3;
				...
				char num18 = seqToUnseq[(uint)c4];
				intPtr = (IntPtr)(int)num18;
				array4[(uint)num18] = array2[(long)intPtr] + 1;
				ll8[last] = seqToUnseq[(uint)c4];
				int num19;
				for (num19 = num10 - 1; num19 > 3; num19 -= 4)
				{
					array[num19] = array[num19 - 1];
					array[num19 - 1] = array[num19 - 2];
					array[num19 - 2] = array[num19 - 3];
					array[num19 - 3] = array[num19 - 4];
				}
				while (num19 > 0)
				{
					array[num19] = array[num19 - 1];
				...
				num4--;
				int num20 = selector[num3];
				int num21 = minLens[num20];
				int num22 = BsR(num21);
				while (num22 > limit[num20][num21])
				{
					num21++;
					while (bsLive < 1)
					{
						...
						int num23 = c5;
						bsBuff = (bsBuff << 8) | (num23 & 0xFF);
						bsLive += 8;
					}
					int num24 = (bsBuff >> bsLive - 1) & 1;
					bsLive--;
					num22 = (num22 << 1) | num24;
				}
				num10 = perm[num20][num22 - basev[num20][num21]];
			}
		}
		...
		private void SetupBlock()
		{
			...
			for (i = 0; i <= last; i++)
			{
				...
				IntPtr intPtr = (IntPtr)(int)c;
				array4[(uint)c] = array2[(long)intPtr] + 1;
			}
			array = null;
			tPos = tt[origPtr];
			count = 0;
