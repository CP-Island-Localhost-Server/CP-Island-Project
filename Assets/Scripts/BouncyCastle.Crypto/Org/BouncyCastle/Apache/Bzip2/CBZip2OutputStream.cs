	...
	public class CBZip2OutputStream : Stream
	{
		...
		private unsafe void SendMTFValues()
		{
			...
			for (int l = 0; l < 4; l++)
			{
				...
				while (num6 < nMTF)
				{
					...
					if (num3 == 6)
					{
						...
						{
							short num16 = szptr[m];
							num15 += (short)array[0][num16];
							num14 += (short)array[1][num16];
							num13 += (short)array[2][num16];
							num12 += (short)array[3][num16];
							num11 += (short)array[4][num16];
							num10 += (short)array[5][num16];
						}
						array4[0] = num15;
						array4[1] = num14;
						array4[2] = num13;
			...
			while (num6 < nMTF)
			{
				...
				for (int m = num6; m <= num8; m++)
				{
					BsW(array[(uint)selector[num26]][szptr[m]], array11[(uint)selector[num26]][szptr[m]]);
				}
				num6 = num8 + 1;
				num26++;
			}
		...
		private void MainSort()
		{
			...
			for (int i = 0; i <= 255; i++)
			{
				...
				for (num6 = 0; num6 <= 255; num6++)
				{
					...
					intPtr = (IntPtr)num12;
					array9[num12] = array4[(long)intPtr] | 0x200000;
				}
				array3[num11] = true;
				if (i < 255)
				{
					int num15 = ftab[num11 << 8] & -2097153;
					int num16 = (ftab[num11 + 1 << 8] & -2097153) - num15;
					int j;
					for (j = 0; num16 >> j > 65534; j++)
					{
					}
					for (num6 = 0; num6 < num16; num6++)
					{
						int num17 = zptr[num15 + num6];
						int num18 = num6 >> j;
						quadrant[num17] = num18;
						if (num17 < 20)
						{
							quadrant[num17 + last + 1] = num18;
						}
					}
					if (num16 - 1 >> j > 65535)
					{
				...
				for (num6 = ftab[num11 << 8] & -2097153; num6 < (ftab[num11 + 1 << 8] & -2097153); num6++)
				{
					...
					if (!array3[num2])
					{
						...
						int num19 = num2;
						intPtr = (IntPtr)num19;
						array10[num19] = array4[(long)intPtr] + 1;
					}
				}
				for (num6 = 0; num6 <= 255; num6++)
				{
					int[] array11 = (array4 = ftab);
					int num20 = (num6 << 8) + num11;
					intPtr = (IntPtr)num20;
					array11[num20] = array4[(long)intPtr] | 0x200000;
				}
			}
		}
		...
		private void RandomiseBlock()
		{
			...
			for (int i = 0; i <= last; i++)
			{
				...
				array2[num3] = (char)((uint)array[(long)intPtr] ^ ((num == 1) ? 1u : 0u));
				char[] array3 = (array = block);
				int num4 = i + 1;
				intPtr = (IntPtr)num4;
				array3[num4] = (char)(array[(long)intPtr] & 0xFFu);
		...
		private void GenerateMTFValues()
		{
			...
			intPtr = (IntPtr)num;
			array4[num] = array2[(long)intPtr] + 1;
			nMTF = num2;
		}
