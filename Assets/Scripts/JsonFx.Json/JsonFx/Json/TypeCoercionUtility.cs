...
namespace JsonFx.Json
{
	public class TypeCoercionUtility
	{
		...
		{
			//Discarded unreachable code: IL_02be, IL_02e8
			...
			if (value is string)
			{
				...
				{
					DateTime result;
					if (DateTime.TryParse((string)value, DateTimeFormatInfo.InvariantInfo, DateTimeStyles.AllowLeadingWhite | DateTimeStyles.AllowTrailingWhite | DateTimeStyles.AllowInnerWhite | DateTimeStyles.NoCurrentDateDefault | DateTimeStyles.RoundtripKind, out result))
					{
						return result;
					}
				}
		...
		{
			//Discarded unreachable code: IL_007e, IL_0089, IL_0107, IL_01bd, IL_0288, IL_02c5, IL_02ef
