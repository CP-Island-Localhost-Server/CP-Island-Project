	...
	public class JsonMapper
	{
		...
		private static void AddObjectMetadata(Type type)
		{
			...
			foreach (PropertyInfo propertyInfo in properties)
			{
				...
				{
					p_data = default(PropertyMetadata);
			...
			{
				p_data = default(PropertyMetadata);
				p_data.Info = fieldInfo;
				p_data.IsField = true;
				p_data.Type = fieldInfo.FieldType;
				ProcessAttributes(ref p_data, fieldInfo);
				value.Properties.Add(fieldInfo.Name, p_data);
			}
		...
		private static void AddTypeProperties(Type type)
		{
			...
			foreach (FieldInfo info in fields)
			{
				...
				p_data.Info = info;
				p_data.IsField = true;
				ProcessAttributes(ref p_data, info);
				list.Add(p_data);
			}
