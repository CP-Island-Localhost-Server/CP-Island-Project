...
{
	[TestFixture]
	public class SignalGroupAny_Test
	{
		private SignalGroupAny mSignalGroup = null;
		...
		public void SetUp()
		{
			...
			mGameObject.AddComponent<SignalGroupAny>();
			Assert.NotNull(mGameObject);
			mSignalGroup = mGameObject.GetComponent<SignalGroupAny>();
