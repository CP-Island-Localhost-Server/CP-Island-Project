...
public class UIFont : MonoBehaviour
{
	...
	public List<BMSymbol> symbols
	{
		get
		{
			return (mReplacement != null) ? mReplacement.symbols : mSymbols;
		}
	}
	...
	public bool isDynamic
	{
		get
		{
			return (mReplacement != null) ? mReplacement.isDynamic : (mDynamicFont != null);
		}
	}
	...
	public void MarkAsChanged()
	{
		...
		i = 0;
		for (int num = symbols.Count; i < num; i++)
		{
			symbols[i].MarkAsChanged();
		}
	}
