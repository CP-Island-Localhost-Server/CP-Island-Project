...
public class EarthMonth2025LightingBake : MonoBehaviour
{
	...
	static void BakeEarthMonth2025()
	{
		EditorSceneManager.OpenScene("Assets/Game/World/Scenes/Events/EarthMonth2025/Town_EarthMonth2025_decorations.unity");
		...
		if (activeScene.IsValid())
		{
			...
			if (targetObject != null)
			{
				...
				GameObjectLocations Gol = targetObject.GetComponent<GameObjectLocations>();
                 ...
                 AssetDatabase.DeleteAsset("Assets/Game/World/Scenes/Events/EarthMonth2025/Town_EarthMonth2025_decorations");
