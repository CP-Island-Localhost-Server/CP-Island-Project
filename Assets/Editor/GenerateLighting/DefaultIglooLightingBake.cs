...
public class DefaultIglooLightingBake : MonoBehaviour
{
	...
	[MenuItem("Generate lighting/Default Igloo")]
	...
	{
		EditorSceneManager.OpenScene("Assets/Modules/Igloo/Resources/Scenes/DefaultIgloo.unity");
		...
		if (activeScene.IsValid())
		{
			...
			if (targetObject != null)
			{
				...
				GameObjectLocations Gol = targetObject.GetComponent<GameObjectLocations>();
                 ...
                 AssetDatabase.DeleteAsset("Assets/Modules/Igloo/Resources/Scenes/DefaultIgloo");
