...
public class CreateAssetBundles : MonoBehaviour
{
    ...
    [MenuItem("Generate CDN AssetBundles/Step 1: Build ClientBundles and Generate ContentManifest.txt")]
    ...
    [MenuItem("Generate CDN AssetBundles/Step 2: Build ContentMainfest.txt and Generate ClientManifestDirectory.json")]
    ...
    [MenuItem("Generate CDN AssetBundles/Step 3: Generate __manifest cpremix prod")]
